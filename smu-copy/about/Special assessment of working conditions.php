...
<main class="about-page">
    <div class="container">
        <h1 class="page-title">Специальная оценка условий труда</h1>
        <p class="page-subtitle">СМУ-1 — О Нас — СОУТ</p>
        ...
        <div class="about-layout">
            ...
            <aside class="about-sidebar">
                <nav class="about-menu">
                    <ul>
                        ...
                        <li><a href="/about/Special assessment of working conditions.php" class="active">Специальная оценка условий труда</a></li>
            ...
            <div class="about-content">
                <div class="sout-content">
                    <div class="sout-section">
                        <h2 class="section-title">Отчеты по специальной оценке условий труда</h2>
                        ...
                        <div class="documents-grid">
                            ...
                            <div class="document-card">
                                ...
                                <div class="doc-info">
                                    <h3 class="doc-title">СОУТ (сводная ведомость)</h3>
                                    <p class="doc-desc">Отчет по специальной оценке условий труда</p>
                                    <p class="doc-number">28.02.2025</p>
                            ...
                            <div class="document-card">
                                ...
                                <div class="doc-info">
                                    <h3 class="doc-title">СОУТ (сводная ведомость)</h3>
                                    <p class="doc-desc">Отчет по специальной оценке условий труда</p>
                                    <p class="doc-number">25.11.2024</p>
                                    <a href="/about/docs/certificates/Для отработки.pdf" class="doc-link" target="_blank">Скачать PDF</a>
                                </div>
                            </div>
                            ...
                            <div class="document-card">
                                ...
                                <div class="doc-info">
                                    <h3 class="doc-title">СОУТ (сводная ведомость)</h3>
                                    <p class="doc-desc">Отчет по специальной оценке условий труда</p>
                                    <p class="doc-number">21.04.2023</p>
                                    <a href="/about/docs/certificates/Для отработки.pdf" class="doc-link" target="_blank">Скачать PDF</a>
                                </div>
                            </div>
                            ...
                            <div class="document-card">
                                ...
                                <div class="doc-info">
                                    <h3 class="doc-title">СОУТ (сводная ведомость)</h3>
                                    <p class="doc-desc">Отчет по специальной оценке условий труда</p>
                                    <p class="doc-number">14.11.2022</p>
                                    <a href="/about/docs/certificates/Для отработки.pdf" class="doc-link" target="_blank">Скачать PDF</a>
                                </div>
                            </div>
                            ...
                            <div class="document-card">
                                ...
                                <div class="doc-info">
                                    <h3 class="doc-title">СОУТ (сводная ведомость)</h3>
                                    <p class="doc-desc">Отчет по специальной оценке условий труда</p>
                                    <p class="doc-number">24.03.2020</p>
                                    <a href="/about/docs/certificates/Для отработки.pdf" class="doc-link" target="_blank">Скачать PDF</a>
                                </div>
                            </div>
                        </div>
